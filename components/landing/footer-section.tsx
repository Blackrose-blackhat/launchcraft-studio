...
const footerLinks = {
  Services: [
    { name: "Discovery & Strategy", href: "#features" },
    { name: "UI/UX Design", href: "#features" },
    { name: "Full-Stack Development", href: "#features" },
    { name: "Launch & Support", href: "#features" },
  ],
  Company: [
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-12 lg:gap-8">
            ...
            <div className="col-span-2">
              <a href="#" className="inline-flex items-center gap-2 mb-6">
                <span className="text-2xl font-display text-white">LaunchCraft</span>
                <span className="text-xs text-white/40 font-mono">studio</span>
              </a>
        ...
        <div className="py-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-white/30">
            &copy; 2025 LaunchCraft. All rights reserved.
          </p>
