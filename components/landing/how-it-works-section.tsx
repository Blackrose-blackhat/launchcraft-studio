...
const steps = [
  {
    ...
    title: "Discover",
    subtitle: "your idea",
    description: "We hop on a call, learn about your vision, and map out the fastest path to a product your users will love. No jargon, no fluff—just clarity.",
    code: ``,
  },
  {
    number: "02",
    ...
    description: "Our designers and developers work in tight sprints—sharing progress every week. You'll see your product come to life in real time.",
    code: ``,
  },
  {
    number: "03",
    title: "Launch",
    subtitle: "& grow",
    description: "We deploy to production, help you onboard your first users, and stick around to fix bugs and ship improvements based on real feedback.",
    code: ``,
  },
];
