...
const testimonials = [
  {
    quote: "I had a rough idea and zero technical skills. LaunchCraft turned it into a product with paying users in just 7 weeks.",
    author: "Sarah Mitchell",
    role: "Founder",
    company: "PetLoop",
    metric: { value: "7 weeks", label: "Idea to paying users" },
  },
  {
    quote: "They explained everything in plain English and kept me in the loop every step. I never felt lost or out of control.",
    author: "Marcus Rivera",
    role: "CEO",
    company: "HomeChef",
    metric: { value: "$320K", label: "Pre-seed raised post-launch" },
  },
  {
    quote: "The handoff was seamless. When we hired our own dev, they picked up the codebase in a day thanks to the clean architecture.",
    author: "Priya Sharma",
    role: "Founder",
    company: "StudyBuddy",
  ...
  {
    quote: "Other agencies wanted 6 months and a huge budget. LaunchCraft shipped our MVP in 6 weeks and it actually looked great.",
    author: "Tom Andersen",
    role: "Co-founder",
    company: "FreightPal",
    metric: { value: "42%", label: "Week-over-week growth" },
  },
];
        ...
        <div className="flex items-center justify-between mb-20">
          <div>
            ...
            <h2 className={`text-4xl lg:text-5xl font-display transition-all duration-1000 ${
              ...
              <span className="text-background/40"> succeed.</span>
            </h2>
          </div>
